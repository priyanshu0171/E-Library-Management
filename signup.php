...
<body>
    ...
    <main>
        <div class="bg-container">
            ...
            <h1 class="centered h1">New User registration</h1>
        </div>
        ...
        <div class="container text-center my-5" style="width: 100%;">
            <div class="row mx-auto">
                ...
                <p class="mt-3 featured-text">Please fill all the details below</p>
                <div class="col-md-12 col-lg-6 mx-auto">
                    <div class="card-body">
                        <form action="authenticate.php" method="POST">
                            <div class="form-floating mb-3">
                                <input type="text" autocomplete="off" class="form-control" id="floatingInput1" placeholder="eg RRI001">
                                <label for="floatingInput1">First Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" autocomplete="off" class="form-control" id="floatingInput2" placeholder="eg RRI001">
                                <label for="floatingInput2">Last Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="email" autocomplete="off" class="form-control" id="floatingInput3" placeholder="eg RRI001">
                                <label for="floatingInput3">E mail</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control" id="floatingPassword4" placeholder="password">
                                <label for="floatingPassword4">Create Password</label>
                            </div>
                            <div class="form-floating">
                                <input type="password" class="form-control" id="floatingPassword5" placeholder="password">
                                <label for="floatingPassword5">Confirm Password</label>
                            </div>
